...
![fonctionnement](https://cellar-c2.services.clever-cloud.com/content/2022/01/schema-asymetrique.jpg)
...
Si vous voulez en savoir plus, je vous invite à **lire cet article pour comprendre le fonctionnement exact d'AES** : [*Advanced encryption standard aes what it is and how it works*](https://securityboulevard.com/2020/04/advanced-encryption-standard-aes-what-it-is-and-how-it-works/)
