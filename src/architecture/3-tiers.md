...
Même si l'architecture 3-tiers et [_le modèle MVC_](https://code-garage.com/blog/comprendre-l-architecture-modele-vue-controleur-mvc) (modèle-vue-contrôleur) **partagent des similitudes en termes de séparation des préoccupations**, ils sont bien différents.
